...
mallet_path = 'path/to/mallet-2.0.8/bin/mallet' [comment]: <> (update this path in [modeling](https://github.com/GMU-Capstone-690/Data-Tagging-via-Content-and-Standards/blob/main/Data%20Modeling/Modeling.py) file.)
